    ...
    with mp_hands.Hands(
        ...
        while cap.isOpened():
            ...
            if key == ord('q'):
                ...
                for i in range(n):
                    if results.multi_hand_landmarks:
                        for hand_landmarks in results.multi_hand_landmarks:
                            ...
                            all_angles_temp = get_angles(hand_landmarks)
                            all_angles[0]+=all_angles_temp[0]
                            all_angles[1]+=all_angles_temp[1]
                            all_angles[2]+=all_angles_temp[2]
                            all_angles[3]+=all_angles_temp[3]
                ...
                str1 += str(int(all_angles[0])/n)
                str2 += str(int(all_angles[1])/n)
                str3 += str(int(all_angles[2])/n)
                str4 += str(int(all_angles[3])/n)
                ...
                cv2.imwrite('data_{}.jpg'.format(time.time()), img)
